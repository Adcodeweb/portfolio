...
export default function Contact() {
  return (
    <div className="text-light bg-dark w-10/12 my-28 max-w-4xl mx-auto p-7 py-10 flex flex-col  items-center justify-center text-center gap-7 shadow-mine shadow-secondary md:flex-row ">
